> %% TRANSCRIPTION CONTEXT: When transcribing category theory diagrams,
> %% extract objects (entities) and morphisms (relationships/arrows).
> %% Map entities to entity types and morphisms to relationships using
> %% ER diagram syntax. Preserve arrow direction and cardinality labels.
>
> **Warning**
>
