> %% TRANSCRIPTION CONTEXT: When transcribing a hand-drawn mind map,
> %% extract the central topic (root node), main branches (first-level
> %% subtopics), and leaf nodes. Map to mindmap syntax using indentation
> %% to represent hierarchy. Preserve text labels on each node.
>
> **Warning**
>
